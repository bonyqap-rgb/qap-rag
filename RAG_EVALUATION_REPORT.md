...
Gerado em: 8/6/2026, 10:13:20 PM
Duração Total da Avaliação: 0.28 s

## Métricas Consolidadas

| Métrica | Valor Obtido | Descrição |
| --- | --- | --- |
| **Tempo Médio de Recuperação** | 2.59 ms | Tempo médio do pipeline de busca e ranking |
...
| --- | --- | --- | --- | --- | --- | --- |
| `Artigo 42` | Artigo | 10.3 | 2 | 0.0646 | 389 | Sim ✅ |
| `inciso I` | Inciso | 2.0 | 2 | 0.0646 | 389 | Sim ✅ |
| `PAD` | Sigla | 1.0 | 2 | 0.1896 | 389 | Sim ✅ |
| `regulamento disciplinar` | Nome de Documento | 1.1 | 2 | 0.1896 | 389 | Sim ✅ |
| `Como funciona o processo de rito sumário?` | Semântica | 1.9 | 2 | 0.0646 | 389 | Sim ✅ |
| `Afastamento por licença médica no RDPM` | Híbrida | 1.2 | 2 | 0.1896 | 389 | Sim ✅ |
| `pergunta aleatória sem sentido nenhum` | Sem correspondência | 0.7 | 0 | 0.0000 | 0 | Não ❌ |
